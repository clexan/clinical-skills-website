import { assertDiagramAccessibility, type DiagramAccessibility } from "@/lib/visual-accessibility";
...
export const diagramManifest: DiagramRecord[] = [
  ...
  accessibility: assertDiagramAccessibility(record.id, record.accessibility),
}));
