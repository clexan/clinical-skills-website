import type { ChapterModule, ChapterRecord, ChapterSourcePath, PartId } from "@/types/content";
...
export function getChaptersForPart(partId: PartId) {
  return chapterIndex.filter((chapter) => chapter.partId === partId);
}

export async function loadChapterModule(sourcePath: ChapterSourcePath) {
