...
export const case098: QuizScenario = {
  id: 'case-098',
  slug: 'cardiac-tamponade-post-cardiac-surgery-obstructive-shock',
...
* **B (Decreased output indicates resolving bleeding):** In the post-operative cardiac surgery patient, sudden decrease in chest tube output with concurrent hemodynamic deterioration is a **red flag for clotted hemothorax or tamponade**, not improvement.
* **C (Diuretics to reduce effusion):** Diuretics are **contraindicated** in cardiac tamponade. They would reduce preload, which is already critically compromised by the tamponade physiology, and would worsen hypotension and cardiac output.
* **D (Dobutamine for inotropy):** Inotropes are ineffective in cardiac tamponade because the primary problem is **mechanical restriction of ventricular filling**, not contractile dysfunction.
