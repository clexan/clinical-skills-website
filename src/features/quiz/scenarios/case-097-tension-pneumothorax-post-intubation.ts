...
export const case097: QuizScenario = {
  id: 'case-097',
...
* **B (Obtain chest X-ray first):** Tension pneumothorax is a **clinical diagnosis** that requires immediate intervention. Delaying treatment to obtain imaging in a hemodynamically unstable patient is contraindicated and can result in cardiac arrest. The classic teaching is "treat first, image later" for tension pneumothorax. The combination of sudden shock after positive pressure ventilation, absent breath sounds, tracheal deviation, and JVD is sufficient for diagnosis.
