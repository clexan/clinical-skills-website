...
export const case106: QuizScenario = {
  id: 'case-106',
  slug: 'anaphylaxis-diagnostic-criteria-normal-blood-pressure',
...
* **C (Three systems):** Guidelines require two or more organ systems after likely allergen exposure (or one system with hypotension/severe airway compromise).
